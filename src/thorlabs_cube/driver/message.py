...
class MGMSG(Enum):
    ...
    QUAD_SET_LOOPPARAMS = 0x0870
    QUAD_REQ_LOOPPARAMS = 0x0871
    QUAD_GET_LOOPPARAMS = 0x0872
    QUAD_SET_OPERMODE = 0x0873
    QUAD_REQ_OPERMODE = 0x0874
    QUAD_GET_OPERMODE = 0x0875
    QUAD_SET_POSDEMANDPARAMS = 0x0876
    QUAD_REQ_POSDEMANDPARAMS = 0x0877
    QUAD_GET_POSDEMANDPARAMS = 0x0878
    QUAD_REQ_STATUSBITS = 0x0879
    QUAD_GET_STATUSBITS = 0x087A
    QUAD_SET_DISPSETTINGS = 0x087B
    QUAD_REQ_DISPSETTINGS = 0x087C
    QUAD_GET_DISPSETTINGS = 0x087D
    QUAD_SET_POSOUTPUTS = 0x087E
    QUAD_REQ_POSOUTPUTS = 0x087F
    QUAD_GET_POSOUTPUTS = 0x0880
    QUAD_SET_LOOPPARAMS2 = 0x0881
    QUAD_REQ_LOOPPARAMS2 = 0x0882
    QUAD_GET_LOOPPARAMS2 = 0x0883
    QUAD_SET_TRIGGERCONFIG = 0x0884
    QUAD_REQ_TRIGGERCONFIG = 0x0885
    QUAD_GET_TRIGGERCONFIG = 0x0886
    QUAD_SET_DIGOUTPUTS = 0x0887
    QUAD_REQ_DIGOUTPUTS = 0x0888
    QUAD_GET_DIGOUTPUTS = 0x0889
